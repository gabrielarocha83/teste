...
namespace Yara.AppService.Dtos
{
    public class TituloDto
    {
        ...
        public bool IncluiuPefin { get; set; }
        public bool ExcluiuPefin { get; set; }
        public bool IncluiuProtesto { get; set; }
        public bool RealizouProtesto { get; set; }
        public bool EmitiuDuplicata { get; set; }

        public Guid ContaClienteId { get; set; }

        public Guid? StatusCobrancaID { get; set; }
        public virtual StatusCobrancaDto StatusCobranca { get; set; }
