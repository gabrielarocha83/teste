...
{
    public class ConfigurationPropostaProrrogacao : EntityTypeConfiguration<PropostaProrrogacao>
    {
        public ConfigurationPropostaProrrogacao()
        {
            ToTable("PropostaProrrogacao");
            HasKey(c => c.ID);
