...
namespace Yara.Data.Entity.Helpers
{
    public class YaraDatabaseInitializer : DropCreateDatabaseIfModelChanges<YaraDataContext>
    {
        ...
        protected override void Seed(YaraDataContext context)
        {
            ...
            var permissaoConceito = Guid.NewGuid();
            ...
            {
                ID = permissaoConceito,
                Nome = "DadosFinanceirosConceitoCobranca_Edit",
                Descricao = "Permite Editar o campo conceito de cobrança do cliente",
                Ativo = true,
                DataCriacao = DateTime.Now
            };
            context.Permissao.Add(permissao05);
            ...
            contacliente.Segmentos.Add(segmento01);
            contacliente.Segmentos.Add(segmento02);

            contacliente.Representantes.Add(representante01);
            contacliente.Representantes.Add(representante02);
