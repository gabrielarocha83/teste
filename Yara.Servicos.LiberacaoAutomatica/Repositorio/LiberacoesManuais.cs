...
{
    public class LiberacoesManuais:ILiberacoesManuais
    {
        public async Task ProcessarLiberacaoManual(string codigo, Guid carteira)
        {
            try
            {
                ...
                {
                    var commandoSQL = "spFluxoAnaliseLiberacaoManual @Numero, @Carteira";
